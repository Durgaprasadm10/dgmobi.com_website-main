...
//if(Config::CURRENT_ENV == Config::PROD_ENV) {
	const SITE_URL = "http://dgmobi.com/santaspot/"; //Website main URL
	//const SITE_URL = "http://localhost/santaspot-2019/"; //Website main URL
//}else {
	//const SITE_URL = "http://192.168.1.229/dgsmsca.com/dgmobi/santaspot-2019/"; //Website main URL
//}
    
    // Paths.
    const PROJECT_PATH = "/var/www/html/dgmobi/santaspot/"; //Project path
