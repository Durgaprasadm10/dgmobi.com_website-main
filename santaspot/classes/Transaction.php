...
//$select .= " and month(dgmobi_buynow_created_on) >= 11 and ";
    ...
    )
    {
        try {
		    ...
		    . "`dgmobi_buynow_pricetype`, "
                    . "`dgmobi_buynow_paypal_order_id` "
                    . ") VALUES ( "
                    . ":firstName, :lastName, :username, :email, :phone, :address, :country, "
                    . ":province, :noOfLicenses, :taxDetails, :totalPrice, :taxPrice, "
                    . ":selectedLanguage,:pricetype , :orderId )";
            ...
            $stmt->bindParam(":pricetype", $price_type);
            $stmt->execute();
