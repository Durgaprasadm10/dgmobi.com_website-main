...
class Config
{
    ...
    const CURRENT_ENV = self::TEST_ENV; //current environment
    
    const SHOW_ERRORS = FALSE; //Display errors on webpage


	const SITE_URL = "http://test.dgmobi.com/buynow/"; //Website main URL
	
    
    // Paths.
    const PROJECT_PATH = "/var/www/html/testdgmobi/buynow/"; //Project path
    ...
    const DB_HOST_mobile = "ideabytesdb.c6hujshgwzfd.us-east-1.rds.amazonaws.com"; //Host name
     const DB_NAME_mobile = "dgsmsca_server_ca"; //Database name
    const DB_USERNAME_mobile = "dgdox"; //User name
    const DB_PASSWORD_mobile = "dgdox"; //Password

    const DB_HOST_mobile_dev = "ideabytesdb.c6hujshgwzfd.us-east-1.rds.amazonaws.com"; //Host name
     const DB_NAME_mobile_dev = "dgsmsca_server_ca_test"; //Database name
    const DB_USERNAME_mobile_dev = "dgdox"; //User name
    const DB_PASSWORD_mobile_dev = "dgdox"; //Password
  ...
  const ANDROIDFLOWATTACHFILE = "/var/www/html/testdgmobi/pdf/DGMobi_Android_App_Installation_Procedure_TDG.pdf";

  const IOSFLOWATTACHFILE="/var/www/html/testdgmobi/pdf/DGMobi_iOS_App_Installation_Procedure_TDG.pdf";
...
const DGMOBI_General_49CFR_iOS  ="https://apps.apple.com/in/app/dgmobi-us-generic/id1188630365";
  ...
  // const PDF_DGMOBI_ANDROID = "/home/dgsms_andriod/US/DGMobi_Android_App_Installation_Procedure_49CFR.pdf";

  // const PDF_DGMOBI_iOS = "/home/dgsms_andriod/US/DGMobi_iOS_App_Installation_Procedure_49CFR.pdf";

  // const PDF_DGMOBI_ANDROID = "C:\\xampp\htdocs\dgmodi\dgmobi\pdf\dgsms-white-papers.pdf";

  const PDF_DGMOBI_ANDROID = "C:\\xampp\htdocs\dgmodi\dgmobi\pdf\dgsms-white-papers.pdf";
  //const PDF_DGMOBI_ANDROID="/var/www/html/testdgmobi/pdf/DGMobi_Android_App_Installation_Procedure_TDG.pdf";

  const PDF_DGMOBI_iOS = "C:\\xampp\htdocs\dgmodi\dgmobi\pdf\dgsms-white-papers.pdf";
  //const PDF_DGMOBI_iOS = "/var/www/html/testdgmobi/pdf/DGMobi_iOS_App_Installation_Procedure_TDG.pdf";
}
