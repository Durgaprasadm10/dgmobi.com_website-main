...
{
  //  echo "customAutoload";
//    $baseDirectory = "/var/www/dgsmsca.com/dgmobi/santaspot/classes/"; // on 17-11-2020
    //$baseDirectory = "/var/www/html/santaspot-2019/classes/";
 //  $baseDirectory = "/var/www/html/dgmobi/santaspot/classes/";    //it is for server santapot

   // $baseDirectory = "../classes/";
       $baseDirectory = "/var/www/html/dgmobi/buynow/classes/";   //for buynow
      //   $baseDirectory = "C:/xampp/htdocs/dgmodi/dgmobi/buynow/classes/"; //it is for local only 
