   ...
   // $validity = "";
    ...
    for ($i = 0; $i < sizeof($products); $i++) {
      ...
      //  for ($j = 0; $j < (int) ($nooflicenses); $j++) {   
            ...
            $joForUser["regulation"] = $regulation;
               ...
               // echo $joForUser["productName"]."*****************";
                switch ($joForUser["productName"]) {
                    ...
                    case ("DGMobi Landstar US 49 CFR"): //DGMOBI Landstar US $(CFR)
                        ...
                        break;
                    case ("DGMobi Generic US 49 CFR"):
                        $playStoreUrl = Config::DGMOBI_General_49CFR_ANDROID;
                        break;
                    case("DGMobi Generic CANADA TDG");
                 ...
                 if($joForUser["regulation"]=="TDG"){ //strpos(joForUser["productName"],"49 CFR")>1
                    $attachedFileUrl = Config::PDF_DGMOBI_ANDROID_CA; //Android installation file  for US
                 }
                 else{
                    $attachedFileUrl = Config::PDF_DGMOBI_ANDROID_US; //Android installation file for CA
                 }
                ...
                switch ($joForUser["productName"]) {
                    ...
                    case("DGMobi Generic CANADA TDG");
                       $playStoreUrl =Config::DGMOBI_General_TDG_iOS;
                        break;
                    case("DGMobi USXPRESS US 49 CFR");
                ...
                if($joForUser["regulation"]=="TDG"){
                    $attachedFileUrl = Config::PDF_DGMOBI_iOS_CA; //ios installation file  for US
                 }
                 else{
                    $attachedFileUrl = Config::PDF_DGMOBI_iOS_US; //ios installation file for CA
                 }
